    ...
    <div class="webform-progressbar-outer">
      ...
      <ol>
        <?php for ($n = 1; $n <= $page_count; $n++): ?>
          <li class="webform-progressbar-page<?php if ($n < $page_num) {
              print ' completed';
         }; ?><?php if ($n == $page_num) {
             print ' current';
            ...
            <span class="webform-progressbar-page-label">
              <span><?php print check_plain($page_labels[$n - 1]); ?></span>
              <?php if ($n < $page_num): ?>
                <span class="element-invisible">Completed step.</span>
              <?php elseif ($n == $page_num): ?>
                <span class="element-invisible">Current step.</span>
              <?php else: ?>
                <span class="element-invisible">Incomplete step.</span>
              <?php endif; ?>
            </span>
            <?php endif; ?>
          </li>
