  ...
  <div class="featured-content"<?php print $content_attributes; ?>>
    ...
    <div class="featured-content__text">
      <?php if (!empty($content['field_title'])): ?>
        <div class="featured-content__title"><?php print render($content['field_title']); ?></div>
      <?php endif; ?>

      <?php if (!empty($content['field_subtitle'])): ?>
        <div class="featured-content__subtitle"><?php print render($content['field_subtitle']); ?></div>
      <?php endif; ?>

      <?php if (!empty($content['field_link_to'])) : ?>
        <div class="featured-content__call_to_action">
          <?php print render($content['field_link_to']); ?>
        </div>
      <?php endif; ?>
    </div>
